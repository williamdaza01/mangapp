...
export const Items = [
  {
    name: "Black Clover",
    id: 1,
    frontpage: blackclover,
    description:
      "Black Clover es una serie de manga y anime que sigue la historia de Asta, un joven huérfano que vive en un mundo donde la magia es común, pero él no tiene capacidad para usarla. Asta sueña con convertirse en el Rey Mago y se une a la Orden de los Caballeros Mágicos con su amigo Yuno, un prodigio mágico. La historia está llena de batallas mágicas, amistades y personajes mágicos en un mundo lleno de aventuras.",
    number: "4",
    date: "2000-21-05",
    ruta: "/blackclover",
    categoria: "Shonen",
  ...
  },
  {
    ...
    frontpage: naruto,
    description:
      "Naruto cuenta la historia de Naruto Uzumaki, un joven ninja con la ambición de convertirse en Hokage, el líder de su aldea. A medida que avanza la trama, Naruto lucha contra enemigos poderosos y aprende valiosas lecciones sobre la amistad y la superación personal.",
    number: "",
    date: "",
    ruta: "/naruto",
    categoria: "Shonen",
